...
/**
 * Mock class for the SingletonPattern, contains a private static field of SingletonMock, a private constructor aswell as a
 * private static method which calls the constructor. the getInstance method is called from a public static method.
 */
...
public class SingletonMock {
    ...
    /**
     * private static method getInstance which calls the constructor, should pass third predicate if called
